...
import {changeMaxValueAC, changeStartValueAC, clickSetButtonAC, InitialStateType} from "../../state/Counter-reducer";


const DisplayWithInputs = () => {
    ...
    return (
        <div className={s.AppLeft}>
            <div className={s.display}>
                <CustomizedInputs errorStatus={maxValueError} onChange={onChangeForMaxValue} value={values.maxValue}
                                  textValue="Max value:"/>
                <CustomizedInputs errorStatus={startValueError} onChange={onChangeForStartValue} value={values.startValue}
